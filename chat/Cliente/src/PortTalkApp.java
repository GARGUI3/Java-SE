 ...
 * @author gargui3
 */
public class PortTalkApp extends Thread {
    ...
    public PortTalkApp(JTextPane p, JTextField f, JButton b, JTextPane u, String s, String ip, Integer pu) {
    ...
    public void displayLocalParameters() {
        ...
        try {
            ...
            error("Errer obteniendo informacion del servidor local");
        }
